  ...
  return (
    <Dialog open={open} onOpenChange={handleOnOpenChange}>
      <DialogTrigger asChild>
        <Button variant="secondary">Demander à l'IA</Button>
      </DialogTrigger>
      <DialogContent
      ...
      >
        <DialogHeader>
          <DialogTitle>Demander à l'IA à propos de vos notes</DialogTitle>
          <DialogDescription>
            Notre IA peut répondre à des questions sur toutes vos notes
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="mt-4 flex flex-col gap-8">
          ...
          {isPending && <p className="animate-pulse text-sm">Réflexion en cours...</p>}
        </div>
        ...
        >
          <Textarea
            ref={textareaRef}
            placeholder="Posez-moi n'importe quelle question sur vos notes..."
